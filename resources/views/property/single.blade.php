            ...
            <div class="w-9/12">
                ...
                <div class="flex justify-between items-center bg-white p-8 mt-10 shadow-sm">
                    ...
                    <div class="border-l-2 border-gray-300 pl-5 ml-5 w-10/12 text-base">
                        ...
                        <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe perspiciatis velit omnis?</p> -->
                    </div>
                </div>
                ...
                <div class="flex justify-between items-center bg-white p-8 mt-10 shadow-sm">
                    ...
                    <div class="border-l-2 border-gray-300 pl-5 ml-5 w-10/12 text-base">
                        {{$property->why_buy}}
                        <!-- Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores repudiandae ullam quis eum voluptate eos quos deserunt ab vitae rerum. -->
                    </div>
                </div>
                ...
                <div class="bg-white p-8 mt-10 shadow-sm" id="description">
                    ...
                    <!-- Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero minus optio doloremque ab amet consectetur. -->
