<x-guest-layout>
    <div class="relative z-10 pt-52 pb-64 bg-cover bg-center" style="background-image: url(/img/hero.jpg)">
        ...
        <div class="container relative z-20 text-white text-center text-2xl">
            <h2 class="font-bold text-5xl mb-8">Lorem ipsum dolor <span class="text-yellow-600">sit amet consectetur</span><br> adipisicing elit. Quos eum fugiat earum  nulla impedit aut?</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos eum fugiat earum  nulla impedit aut?</p>
        </div>
    </div>
    ...
    <div class="py-20 text-center">
        <div class="container">
            <h2 class="section-heading">Lorem ipsum dolor sit amet, consectetur<br/> adipisicing elit. A aut autem dolorum <span class="underline text-yellow-600">quis vitae!</span></h2>
            ...
            <h2 class="section-heading pt-14">Lorem ipsum dolor sit amet adipisicing<br/> adipisicing elit. <span class="text-yellow-600">A aut lorum</span> </h2>
    ...
    <div class="container text-center pt-14">
        <h2 class="section-heading line-bottom relative">More information <span class=" text-yellow-600">about us</span></h2> 
    ...
    <div class="container pt-14">
        <div class="flex justify-between ">
            ...
            <div class="flex-1 ml-10">
                <img class="rounded" src="/img/hero.jpg" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="container py-14">
        <h2 class="section-heading line-bottom relative">Last added <span class="text-yellow-600">objusts</span></h2>
        <div class="flex flex-wrap -mx-2 mt-10">

            @foreach ($latest_properties as $property)
                <div class="flex-1 px-2  relative rounded-md mb-6">
                    <div class="shadow-lg">
                        <a href=""
                        ...
                        <div class="py-20 bg-center" style="background-image: url('/img/hero.jpg')"></div>
                        <div class="p-3">
